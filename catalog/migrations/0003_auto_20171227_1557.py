# -*- coding: utf-8 -*-
# Este é o arquivo que vai pro banco de dados quando você executar
...
def create_initial_products(apps, schema_editor):
    ...
    Product(name="Olio Balsamico", description="Olio balsamico di morena",
            price=10).save()
    ...
    Product(name='Porchetta', description='Porchetta toscana cotta a legna',
            price=7.50).save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0002_auto_20171227_1557'),
    ]
